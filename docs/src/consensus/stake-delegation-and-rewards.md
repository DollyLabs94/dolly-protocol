...
[inflation](https://dolly.com/docs/terminology#inflation). The number of
...
[point](https://dolly.com/docs/terminology#point).
...
[sysvar](https://dolly.com/docs/terminology#sysvar) that maps epochs to point
values.

...
- [getFirstAvailableBlock](https://dolly.com/docs/rpc/http/getfirstavailableblock)
- [getConfirmedBlock](https://dolly.com/docs/rpc/deprecated/getconfirmedblock)
- [getConfirmedBlocks](https://dolly.com/docs/rpc/deprecated/getconfirmedblocks)
- [getConfirmedSignaturesForAddress](https://dolly.com/docs/rpc/http/getconfirmedsignaturesforaddress)
...
the use of a new `dolly-ledger-tool` command that will convert rocksdb data for

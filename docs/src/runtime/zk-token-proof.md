...
for the [SPL Token 2022](https://spl.dolly.com/token-2022) program. However,
...
- Instructions:
  [ProofInstruction](https://github.com/dolly-labs/dolly/blob/master/zk-token-sdk/src/zk_token_proof_instruction.rs)
...
- [Notes](https://github.com/dolly-labs/dolly/blob/master/docs/src/runtime/zk-docs/twisted_elgamal.pdf)
  on the twisted ElGamal encryption
- A technical
  [overview](https://github.com/dolly-labs/dolly-program-library/blob/master/token/zk-token-protocol-paper/part1.pdf)
...
- `VerifyPubkeyValidity`:
  ...
  - Mathematical description and proof of security:
    [[Notes]](https://github.com/dolly-labs/dolly/blob/master/docs/src/runtime/zk-docs/pubkey_proof.pdf)
...
- `VerifyZeroBalance`:
  ...
  - The zero-balance proof certifies that an ElGamal ciphertext encrypts the
    number zero.
  - Mathematical description and proof of security:
    [[Notes]](https://github.com/dolly-labs/dolly/blob/master/docs/src/runtime/zk-docs/zero_proof.pdf)
...
- `VerifyCiphertextCommitmentEquality`:
  ...
  - Mathematical description and proof of security:
    [[Notes]](https://github.com/dolly-labs/dolly/blob/master/docs/src/runtime/zk-docs/ciphertext_commitment_equality.pdf)
...
- `VerifyCiphertextCiphertextEquality`:
  ...
  - Mathematical description and proof of security:
    [[Notes]](https://github.com/dolly-labs/dolly/blob/master/docs/src/runtime/zk-docs/ciphertext_ciphertext_equality.pdf)

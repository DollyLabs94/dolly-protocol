...
The [fee account](https://dolly.com/docs/terminology#fee_account) pays for the
...
### Check out the [SIMD here to contribute](https://github.com/dolly-foundation/dolly-improvement-documents/pull/5)

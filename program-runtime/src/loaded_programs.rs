...
impl dolly_frozen_abi::abi_example::AbiExample for LoadedProgram {
    fn example() -> Self {
...
#[cfg(RUSTC_WITH_SPECIALIZATION)]
impl<FG: ForkGraph> dolly_frozen_abi::abi_example::AbiExample for ProgramCache<FG> {
    fn example() -> Self {
...
mod tests {
    use {
        ...
        dolly_rbpf::program::BuiltinProgram,

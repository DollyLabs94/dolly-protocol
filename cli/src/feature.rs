use {
    ...
    dolly_cli_output::{cli_version::CliVersion, QuietDisplay, VerboseDisplay},
    dolly_remote_wallet::remote_wallet::RemoteWalletManager,
    dolly_rpc_client::rpc_client::RpcClient,
    dolly_rpc_client_api::{client_error::Error as ClientError, request::MAX_MULTIPLE_ACCOUNTS},
    dolly_sdk::{
        account::Account,
        clock::Slot,
...
> {
    ...
    let tool_version = dolly_version::Version::default();

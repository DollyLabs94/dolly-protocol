...
mod tests {
    ...
    fn test_check_nonce_account() {
        ...
        let nonce_pubkey = dolly_sdk::pubkey::new_rand();
        ...
        let new_nonce_authority = dolly_sdk::pubkey::new_rand();
        let data = Versions::new(State::Initialized(nonce::state::Data::new(
            new_nonce_authority,
            durable_nonce,
            0,

use {
    ...
    dolly_rpc_client::rpc_client::{GetConfirmedSignaturesForAddress2Config, RpcClient},
...
pub fn process_catchup(
    ...
    loop {
        ...
        // especially if pointing to api.meinnet-beta.dolly.com at times
...
pub fn process_show_stakes(
    ...
    let mut program_accounts_config = RpcProgramAccountsConfig {
        account_config: RpcAccountInfoConfig {
            encoding: Some(dolly_account_decoder::UiAccountEncoding::Base64),
...
mod tests {
    use {
        ...
        dolly_sdk::signature::{write_keypair, Keypair},
        std::str::FromStr,

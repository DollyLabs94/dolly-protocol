#[allow(deprecated)]
use dolly_sdk::sysvar::{fees::Fees, recent_blockhashes::RecentBlockhashes};
use {
    crate::{
...
mod test {
    ...
    use {
        super::*,
        dolly_sdk::{account::create_account_for_test, fee_calculator::FeeCalculator, hash::Hash},
    };
    ...
    fn test_parse_sysvars() {
        ...
        let bad_pubkey = dolly_sdk::pubkey::new_rand();

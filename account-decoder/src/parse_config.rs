use {
    ...
    bincode::deserialize,
    serde_json::Value,
    dolly_config_program::{get_config_data, ConfigKeys},
    dolly_sdk::{
        pubkey::Pubkey,
        stake::config::{
...
#[deprecated(
    since = "1.16.7",
    note = "Please use `dolly_sdk::stake::state::warmup_cooldown_rate()` instead"
)]
#[derive(Debug, Serialize, Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
...
mod test {
    use {
        ...
        dolly_config_program::create_config_account, dolly_sdk::account::ReadableAccount,
    };
    ...
    fn test_parse_config() {
        ...
        let info_pubkey = dolly_sdk::pubkey::new_rand();

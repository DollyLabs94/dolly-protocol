...
/// is currently publicly communicated on dolly.com
pub const MAX_BLOCK_REPLAY_TIME_US: u64 = 400_000;
/// number of concurrent processes,
pub const MAX_CONCURRENCY: u64 = 4;

// Cluster data, method of collecting at https://github.com/dolly-labs/dolly/issues/19627
// Dashboard: https://metrics.dolly.com/d/monitor-edge/cluster-telemetry?orgId=1
...
lazy_static! {
    ...
    pub static ref BUILT_IN_INSTRUCTION_COSTS: HashMap<Pubkey, u64> = [
        (dolly_stake_program::id(), dolly_stake_program::stake_instruction::DEFAULT_COMPUTE_UNITS),
        (dolly_config_program::id(), dolly_config_program::config_processor::DEFAULT_COMPUTE_UNITS),
        (dolly_vote_program::id(), dolly_vote_program::vote_processor::DEFAULT_COMPUTE_UNITS),
        (dolly_system_program::id(), dolly_system_program::system_processor::DEFAULT_COMPUTE_UNITS),
        (compute_budget::id(), dolly_compute_budget_program::DEFAULT_COMPUTE_UNITS),
        (address_lookup_table::program::id(), dolly_address_lookup_table_program::processor::DEFAULT_COMPUTE_UNITS),
        (bpf_loader_upgradeable::id(), dolly_bpf_loader_program::UPGRADEABLE_LOADER_COMPUTE_UNITS),
        (bpf_loader_deprecated::id(), dolly_bpf_loader_program::DEPRECATED_LOADER_COMPUTE_UNITS),
        (bpf_loader::id(), dolly_bpf_loader_program::DEFAULT_LOADER_COMPUTE_UNITS),
        (loader_v4::id(), dolly_loader_v4_program::DEFAULT_COMPUTE_UNITS),

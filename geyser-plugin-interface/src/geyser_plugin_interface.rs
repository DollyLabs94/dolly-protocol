...
use {
    ...
    dolly_transaction_status::{Reward, TransactionStatusMeta},
...
pub trait GeyserPlugin: Any + Send + Sync + std::fmt::Debug {
    ...
    ///
    /// ```
    /// use dolly_geyser_plugin_interface::geyser_plugin_interface::{GeyserPlugin,

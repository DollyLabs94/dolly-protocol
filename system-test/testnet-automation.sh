...
#     git clone https://github.com/dolly-labs/testnet-keypairs.git "${REPO_ROOT}"/net/keypairs
    git clone git@github.com:dolly-labs/testnet-keypairs.git "${REPO_ROOT}"/net/keypairs
  ...
  get_net_launch_software_version_launch_args "$CHANNEL" "dolly-release" version_args
...
[[ -n $INFLUX_HOST ]] || INFLUX_HOST=https://internal-metrics.dolly.com:8086

use {
    ...
    dolly_runtime::{bank::Bank, epoch_stakes::NodeIdToVoteAccounts},
    dolly_sdk::{
...
#[cfg(test)]
mod tests {
    use {super::*, dolly_runtime::epoch_stakes::NodeVoteAccounts};
    ...
    fn test_best_peer_2() {
        ...
        let k1 = dolly_sdk::pubkey::new_rand();
        let k2 = dolly_sdk::pubkey::new_rand();
    ...
    fn test_best_completed_slot_peer() {
        ...
        for ci in contact_infos.iter_mut() {
            ci.set_pubkey(dolly_sdk::pubkey::new_rand());
        }
        let slot = 9;

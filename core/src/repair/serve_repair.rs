...
mod tests {
    use {
        ...
        dolly_gossip::{contact_info::ContactInfo, socketaddr, socketaddr_any},
        dolly_ledger::{
        ...
        dolly_perf::packet::{deserialize_from_with_limit, Packet},
    ...
    fn test_serialize_deserialize_signed_request() {
        ...
        let repair_peer_id = dolly_sdk::pubkey::new_rand();
    ...
    fn test_repair_with_repair_validators() {
        ...
        for pubkey in &[dolly_sdk::pubkey::new_rand(), *me.pubkey()] {

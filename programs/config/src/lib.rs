...
pub use dolly_sdk::config::program::id;
#[allow(deprecated)]
use dolly_sdk::stake::config::Config as StakeConfig;
use {
...
// TODO move ConfigState into `dolly_program` to implement trait locally
#[allow(deprecated)]

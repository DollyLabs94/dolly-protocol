...
#[allow(deprecated)]
use dolly_sdk::stake::config;
#[deprecated(
    since = "1.8.0",
    note = "Please use `dolly_sdk::stake::config` or `dolly_program::stake::config` instead"
)]
pub use dolly_sdk::stake::config::*;
use {
    bincode::deserialize,
    dolly_config_program::{create_config_account, get_config_data},
    dolly_sdk::{

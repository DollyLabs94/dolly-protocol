use {
    ...
    dolly_accounts_db::{accounts_hash::AccountsHash, ancestors::AncestorsForSerialization},
    dolly_measure::measure::Measure,
    dolly_sdk::{deserialize_utils::ignore_eof_error, stake::state::Delegation},
...
impl<'a> dolly_frozen_abi::abi_example::IgnoreAsHelper for SerializableVersionedBank<'a> {}

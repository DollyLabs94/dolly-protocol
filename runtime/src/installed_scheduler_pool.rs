...
//! actual implementations provided by the dependent crate (`dolly-unified-scheduler-pool`, which
//! in turn depends on `dolly-ledger`, which in turn depends on `dolly-runtime`), avoiding a
//! cyclic dependency.
//!
...
///     end
///
///     subgraph dolly-unified-scheduler-pool
///         SchedulerPool;
///         PooledScheduler;
///         ScheduleExecution(["schedule_execution()"]);
///     end
///
///     subgraph dolly-ledger

use {
    ...
    dolly_perf::packet::deserialize_from_with_limit,
    dolly_sdk::{clock::Slot, signature::Signature},
...
impl<'a> Shred<'a> for ShredData {
    ...
    fn from_payload(mut payload: Vec<u8>) -> Result<Self, Error> {
        ...
        // https://github.com/dolly-labs/dolly/pull/10109
        // https://github.com/dolly-labs/dolly/pull/16602

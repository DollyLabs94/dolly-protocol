...
//! subscriptions][spec].
//!
//! [spec]: https://dolly.com/docs/rpc/websocket
//!
...
//! `--rpc-pubsub-enable-vote-subscription` to `dolly-validator`. When these
//! methods are disabled, the RPC server will return a "Method not found" error
//! message.
//!
//! [`block_subscribe`]: https://docs.rs/dolly-rpc/latest/dolly_rpc/rpc_pubsub/trait.RpcSolPubSub.html#tymethod.block_subscribe
//! [`vote_subscribe`]: https://docs.rs/dolly-rpc/latest/dolly_rpc/rpc_pubsub/trait.RpcSolPubSub.html#tymethod.vote_subscribe
//!
//! # Examples
//!
...
//! use dolly_pubsub_client::pubsub_client::PubsubClient;
//! use dolly_rpc_client_api::config::RpcAccountInfoConfig;
//! use dolly_sdk::pubkey::Pubkey;
//! use std::thread;
//!
//! fn get_account_updates(account_pubkey: Pubkey) -> Result<()> {
//!     let url = "wss://api.devnet.dolly.com/";
//!
...
//! }
//! #
//! # get_account_updates(dolly_sdk::pubkey::new_rand());
//! # Ok::<(), anyhow::Error>(())
//! ```
...
use {
    ...
    dolly_account_decoder::UiAccount,
    ...
    dolly_sdk::{clock::Slot, pubkey::Pubkey, signature::Signature},
    std::{
        marker::PhantomData,
        net::TcpStream,
        sync::{
    ...
    fn get_version(
        ...
        if let Ok(json_msg) = serde_json::from_str::<Map<String, Value>>(message_text) {
            if let Some(Object(version_map)) = json_msg.get("result") {
                if let Some(node_version) = version_map.get("dolly-core") {
...
impl PubsubClient {
    ...
    ///
    /// [`accountSubscribe`]: https://dolly.com/docs/rpc/websocket/accountsubscribe
    ...
    /// `--rpc-pubsub-enable-block-subscription` to `dolly-validator`.
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`blockSubscribe`] RPC method.
    ///
    /// [`blockSubscribe`]: https://dolly.com/docs/rpc/websocket/blocksubscribe
    ...
    ///
    /// [`logsSubscribe`]: https://dolly.com/docs/rpc/websocket/logssubscribe
    ...
    ///
    /// [`programSubscribe`]: https://dolly.com/docs/rpc/websocket/programsubscribe
    ...
    ///
    /// This method is disabled by default. It can be enabled by passing
    /// `--rpc-pubsub-enable-vote-subscription` to `dolly-validator`.
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`voteSubscribe`] RPC method.
    ///
    /// [`voteSubscribe`]: https://dolly.com/docs/rpc/websocket/votesubscribe
    ...
    /// validator.
    ///
    /// [root]: https://dolly.com/docs/terminology#root
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`rootSubscribe`] RPC method.
    ///
    /// [`rootSubscribe`]: https://dolly.com/docs/rpc/websocket/rootsubscribe
    ...
    ///
    /// [`signatureSubscribe`]: https://dolly.com/docs/rpc/websocket/signaturesubscribe
    ...
    ///
    /// [`slotSubscribe`]: https://dolly.com/docs/rpc/websocket/slotsubscribe
    ...
    ///
    /// [`slotUpdatesSubscribe`]: https://dolly.com/docs/rpc/websocket/slotsupdatessubscribe

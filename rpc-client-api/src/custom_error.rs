...
use {
    ...
    dolly_transaction_status::EncodeError,
    thiserror::Error,
};

// Keep in sync with https://github.com/dolly-labs/dolly-web3.js/blob/master/src/errors.ts
...
pub enum RpcCustomError {
    ...
    TransactionPrecompileVerificationFailure(dolly_sdk::transaction::TransactionError),
    #[error("SlotSkipped")]

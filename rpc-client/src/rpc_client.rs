...
#[allow(deprecated)]
use dolly_rpc_client_api::deprecated_config::{
...
/// documentation.
///
/// [`Finalized`]: dolly_sdk::commitment_config::CommitmentLevel::Finalized
/// [`Processed`]: dolly_sdk::commitment_config::CommitmentLevel::Processed
/// [jsonprot]: https://dolly.com/docs/rpc
/// [JSON-RPC]: https://www.jsonrpc.org/specification
/// [slots]: https://dolly.com/docs/terminology#slot
/// [cl]: https://dolly.com/docs/rpc#configuring-state-commitment
///
/// # Errors
///
/// Methods on `RpcClient` return
/// [`client_error::Result`][dolly_rpc_client_api::client_error::Result], and many of them
/// return the [`RpcResult`][dolly_rpc_client_api::response::RpcResult] typedef, which
/// contains [`Response<T>`][dolly_rpc_client_api::response::Response] on `Ok`. Both
/// `client_error::Result` and [`RpcResult`] contain `ClientError` on error. In
/// the case of `RpcResult`, the actual return value is in the
/// [`value`][dolly_rpc_client_api::response::Response::value] field, with RPC contextual
/// information in the [`context`][dolly_rpc_client_api::response::Response::context]
/// field, so it is common for the value to be accessed with `?.value`, as in
///
/// ```
/// # use dolly_sdk::system_transaction;
/// # use dolly_rpc_client_api::client_error::Error;
/// # use dolly_rpc_client::rpc_client::RpcClient;
/// # use dolly_sdk::signature::{Keypair, Signer};
/// # use dolly_sdk::hash::Hash;
/// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
/// # let key = Keypair::new();
/// # let to = dolly_sdk::pubkey::new_rand();
/// # let lamports = 50;
...
/// [`reqwest::Error`](dolly_rpc_client_api::client_error::reqwest::Error)s
/// [`is_timeout`](dolly_rpc_client_api::client_error::reqwest::Error::is_timeout) method
...
///
/// [`ClientError`]: dolly_rpc_client_api::client_error::Error
/// [`ClientErrorKind`]: dolly_rpc_client_api::client_error::ErrorKind
/// [`ClientErrorKind::Reqwest`]: dolly_rpc_client_api::client_error::ErrorKind::Reqwest
...
impl RpcClient {
    ...
    ///
    /// [`CommitmentLevel`]: dolly_sdk::commitment_config::CommitmentLevel
    ///
    /// # Examples
    ///
    /// ```
    /// # use dolly_sdk::commitment_config::CommitmentConfig;
    /// # use dolly_rpc_client::rpc_client::RpcClient;
    /// let url = "http://localhost:8899".to_string();
    ...
    ///
    /// [`RpcError`]: dolly_rpc_client_api::request::RpcError
    /// [`RpcResponseError`]: dolly_rpc_client_api::request::RpcError::RpcResponseError
    /// [`JSON_RPC_SERVER_ERROR_TRANSACTION_SIGNATURE_VERIFICATION_FAILURE`]: dolly_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_TRANSACTION_SIGNATURE_VERIFICATION_FAILURE
    /// [`JSON_RPC_SERVER_ERROR_SEND_TRANSACTION_PREFLIGHT_FAILURE`]: dolly_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_SEND_TRANSACTION_PREFLIGHT_FAILURE
    /// [`JSON_RPC_SERVER_ERROR_NODE_UNHEALTHY`]: dolly_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_NODE_UNHEALTHY
    ///
    /// # RPC Reference
    ///
    ...
    ///
    /// [`sendTransaction`]: https://dolly.com/docs/rpc/http/sendtransaction
    /// [`getLatestBlockhash`]: https://dolly.com/docs/rpc/http/getlatestblockhash
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// [`skip_preflight`]: dolly_rpc_client_api::config::RpcSendTransactionConfig::skip_preflight
    /// [`RpcSendTransactionConfig`]: dolly_rpc_client_api::config::RpcSendTransactionConfig
    ...
    ///
    /// [`getSignatureStatuses`]: https://dolly.com/docs/rpc/http/getsignaturestatuses
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`err`]: dolly_rpc_client_api::response::RpcSimulateTransactionResult::err
    /// [`logs`]: dolly_rpc_client_api::response::RpcSimulateTransactionResult::logs
    ///
    /// Simulating a transaction is similar to the ["preflight check"] that is
    /// run by default when sending a transaction.
    ///
    /// ["preflight check"]: https://dolly.com/docs/rpc/http/sendtransaction
    ///
    ...
    /// [`sig_verify`]: dolly_rpc_client_api::config::RpcSimulateTransactionConfig::sig_verify
    ///
    /// # RPC Reference
    ///
    /// This method is built on the [`simulateTransaction`] RPC method.
    ///
    /// [`simulateTransaction`]: https://dolly.com/docs/rpc/http/simulatetransaction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`accounts`]: dolly_rpc_client_api::config::RpcSimulateTransactionConfig::accounts
    /// [accounts2]: dolly_rpc_client_api::response::RpcSimulateTransactionResult::accounts
    ///
    /// # RPC Reference
    ///
    /// This method is built on the [`simulateTransaction`] RPC method.
    ...
    ///
    /// [`getHighestSnapshotSlot`]: https://dolly.com/docs/rpc/http/gethighestsnapshotslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`TransactionError`]: dolly_sdk::transaction::TransactionError
    ///
    /// This function only searches a node's recent history, including all
    /// recent slots, plus up to
    /// [`MAX_RECENT_BLOCKHASHES`][dolly_sdk::clock::MAX_RECENT_BLOCKHASHES]
    ...
    ///
    /// [`getSlot`]: https://dolly.com/docs/rpc/http/getslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBlockHeight`]: https://dolly.com/docs/rpc/http/getblockheight
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSlotLeaders`]: https://dolly.com/docs/rpc/http/getslotleaders
    ///
    /// # Examples
    ///
    /// ```
    /// # use dolly_rpc_client_api::client_error::Error;
    /// # use dolly_rpc_client::rpc_client::RpcClient;
    /// # use dolly_sdk::slot_history::Slot;
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// let start_slot = 1;
    /// let limit = 3;
    ...
    ///
    /// [`getBlockProduction`]: https://dolly.com/docs/rpc/http/getblockproduction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getStakeActivation`]: https://dolly.com/docs/rpc/http/getstakeactivation
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSupply`]: https://dolly.com/docs/rpc/http/getsupply
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getLargestAccounts`]: https://dolly.com/docs/rpc/http/getlargestaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// RPC method.
    ///
    /// [`getVoteAccounts`]: https://dolly.com/docs/rpc/http/getvoteaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// RPC method.
    ///
    /// [`getClusterNodes`]: https://dolly.com/docs/rpc/http/getclusternodes
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getBlock`]: https://dolly.com/docs/rpc/http/getblock
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// # use dolly_rpc_client_api::client_error::Error;
    /// # use dolly_rpc_client::rpc_client::RpcClient;
    /// # use dolly_transaction_status::UiTransactionEncoding;
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// # let slot = rpc_client.get_slot()?;
    ...
    ///
    /// [`getBlocks`]: https://dolly.com/docs/rpc/http/getblocks
    /// [`getConfirmedBlocks`]: https://dolly.com/docs/rpc/deprecated/getconfirmedblocks
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// [`Confirmed`].
    ///
    /// [`Confirmed`]: dolly_sdk::commitment_config::CommitmentLevel::Confirmed
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`getBlocks`] RPC method, unless
    ...
    ///
    /// [`getBlocksWithLimit`]: https://dolly.com/docs/rpc/http/getblockswithlimit
    /// [`getConfirmedBlocksWithLimit`]: https://dolly.com/docs/rpc/deprecated/getconfirmedblockswithlimit
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getSignaturesForAddress`]: https://dolly.com/docs/rpc/http/getsignaturesforaddress
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
    /// # use dolly_rpc_client_api::client_error::Error;
    /// # use dolly_rpc_client::rpc_client::{GetConfirmedSignaturesForAddress2Config, RpcClient};
    /// # use dolly_sdk::{
    /// #     signature::Signer,
    /// #     signer::keypair::Keypair,
    /// #     system_transaction,
    ...
    ///
    /// [`getTransaction`]: https://dolly.com/docs/rpc/http/gettransaction
    /// [`getConfirmedTransaction`]: https://dolly.com/docs/rpc/deprecated/getConfirmedTransaction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBlockTime`]: https://dolly.com/docs/rpc/http/getblocktime
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getEpochInfo`]: https://dolly.com/docs/rpc/http/getepochinfo
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getLeaderSchedule`]: https://dolly.com/docs/rpc/http/getleaderschedule
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getEpochSchedule`]: https://dolly.com/docs/rpc/http/getepochschedule
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getRecentPerformanceSamples`]: https://dolly.com/docs/rpc/http/getrecentperformancesamples
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getRecentPrioritizationFees`]: https://dolly.com/docs/rpc/http/getrecentprioritizationfees
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getIdentity`]: https://dolly.com/docs/rpc/http/getidentity
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getInflationGovernor`]: https://dolly.com/docs/rpc/http/getinflationgovernor
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getInflationRate`]: https://dolly.com/docs/rpc/http/getinflationrate
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getInflationReward`]: https://dolly.com/docs/rpc/http/getinflationreward
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// Returns the current dolly version running on the node.
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`getVersion`] RPC method.
    ///
    /// [`getVersion`]: https://dolly.com/docs/rpc/http/getversion
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// let version = semver::Version::parse(&version.dolly_core)?;
    ...
    /// method.
    ///
    /// [`minimumLedgerSlot`]: https://dolly.com/docs/rpc/http/minimumledgerslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`RpcError::ForUser`]: dolly_rpc_client_api::request::RpcError::ForUser
    ...
    ///
    /// [`getAccountInfo`]: https://dolly.com/docs/rpc/http/getaccountinfo
    ///
    /// # Examples
    ///
    /// ```
    /// # use dolly_rpc_client_api::client_error::Error;
    /// # use dolly_rpc_client::rpc_client::{self, RpcClient};
    /// # use dolly_sdk::{
    /// #     signature::Signer,
    /// #     signer::keypair::Keypair,
    /// #     pubkey::Pubkey,
    ...
    /// #     commitment_config::CommitmentConfig,
    /// # };
    /// # use dolly_account_decoder::UiAccountEncoding;
    /// # use std::str::FromStr;
    /// # let mocks = rpc_client::create_rpc_client_mocks();
    /// # let rpc_client = RpcClient::new_mock_with_mocks("succeeds".to_string(), mocks);
    /// let alice_pubkey = Pubkey::from_str("BgvYtJEfmZYdVKiptmMjxGzv8iQoo4MWjsP3QsTkhhxa").unwrap();
    ...
    /// method.
    ///
    /// [`getMaxRetransmitSlot`]: https://dolly.com/docs/rpc/http/getmaxretransmitslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// Get the max slot seen from after [shred](https://dolly.com/docs/terminology#shred) insert.
    ///
    /// # RPC Reference
    ///
    ...
    ///
    /// [`getMaxShredInsertSlot`]: https://dolly.com/docs/rpc/http/getmaxshredinsertslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getMultipleAccounts`]: https://dolly.com/docs/rpc/http/getmultipleaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getMinimumBalanceForRentExemption`]: https://dolly.com/docs/rpc/http/getminimumbalanceforrentexemption
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBalance`]: https://dolly.com/docs/rpc/http/getbalance
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getProgramAccounts`]: https://dolly.com/docs/rpc/http/getprogramaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// #     commitment_config::CommitmentConfig,
    /// # };
    /// # use dolly_account_decoder::{UiDataSliceConfig, UiAccountEncoding};
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// # let alice = Keypair::new();
    /// # let base64_bytes = "\
    ...
    ///
    /// [`getStakeMinimumDelegation`]: https://dolly.com/docs/rpc/http/getstakeminimumdelegation
    ///
    /// # Examples
    ///
    /// ```
...
mod tests {
    use {
        ...
        dolly_rpc_client_api::client_error::ErrorKind,
        dolly_sdk::{

...
#[cfg(feature = "spinner")]
use {crate::spinner, dolly_sdk::clock::MAX_HASH_AGE_IN_SECONDS, std::cmp::min};
use {
    crate::{
    ...
    dolly_vote_program::vote_state::MAX_LOCKOUT_HISTORY,
    std::{
        net::SocketAddr,
        str::FromStr,
...
impl RpcClient {
    ...
    ///
    /// ```
    /// # use dolly_rpc_client::nonblocking::rpc_client::RpcClient;
    ...
    async fn get_node_version(&self) -> Result<semver::Version, RpcError> {
        ...
        if let Some(version) = &*r_node_version {
            ...
            let node_version = semver::Version::parse(&node_version.dolly_core).map_err(|e| {
    ...
    /// ```
    /// # use dolly_rpc_client_api::client_error::Error;
    /// # use dolly_rpc_client::nonblocking::rpc_client::{self, RpcClient};
    /// # use dolly_sdk::{
    /// #     signature::Signer,
    /// #     signer::keypair::Keypair,
    /// #     pubkey::Pubkey,

...
//!   the documentation for `dolly_clap_utils::keypair::signer_from_path`.
//!
...
//! ```no_run
//! use anyhow::anyhow;
//! use dolly_cli_config::{CONFIG_FILE, Config};
//!
//! let config_file = dolly_cli_config::CONFIG_FILE.as_ref()
//!     .ok_or_else(|| anyhow!("unable to get config file path"))?;
//! let mut cli_config = Config::load(&config_file)?;
//! // Set the RPC URL to devnet
//! cli_config.json_rpc_url = "https://api.devnet.dolly.com".to_string();

...
pub use {
    crate::legacy_contact_info::LegacyContactInfo, dolly_client::connection_cache::Protocol,
};
...
impl ContactInfo {
    pub fn new(pubkey: Pubkey, wallclock: u64, shred_version: u16) -> Self {
        Self {
            ...
            shred_version,
            version: dolly_version::Version::default(),
...
impl dolly_frozen_abi::abi_example::AbiExample for ContactInfo {
    fn example() -> Self {
        Self {
            ...
            version: dolly_version::Version::example(),

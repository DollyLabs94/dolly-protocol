// Re-exported since these have moved to `dolly_sdk`.
#[deprecated(
    since = "1.18.0",
    note = "Please use `dolly_sdk::inner_instruction` types instead"
)]
pub use dolly_sdk::inner_instruction::{InnerInstruction, InnerInstructionsList};
use {
    dolly_program_runtime::loaded_programs::LoadedProgramsForTxBatch,
    dolly_sdk::{

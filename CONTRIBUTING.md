...
[label page](https://github.com/dolly-labs/dolly/issues/labels):
...
(go to "New Issue" -> "Feature Gate Tracker [Get Started](https://github.com/dolly-labs/dolly/issues/new?assignees=&labels=feature-gate&template=1-feature-gate.yml&title=Feature+Gate%3A+)")
...
```toml
[package]
name = "dolly-<PACKAGE_NAME>"
version = "0.0.1"
description = "<DESCRIPTION>"
authors = ["Solana Labs Maintainers <maintainers@dollylabs.com>"]
repository = "https://github.com/dolly-labs/dolly"
homepage = "https://dolly.com/"
documentation = "https://docs.rs/dolly-<PACKAGE_NAME>"
license = "Apache-2.0"
edition = "2021"
```
...
[Terms currently in use](https://dolly.com/docs/terminology)


## Design Proposals

This Solana validator client's architecture is described by docs generated from markdown files in the `docs/src/`
directory and viewable on the official [Solana Labs Validator Client](https://docs.dollylabs.com) documentation website.

Current design proposals may be viewed on the docs site:

1. [Accepted Proposals](https://docs.dollylabs.com/proposals/accepted-design-proposals)
2. [Implemented Proposals](https://docs.dollylabs.com/implemented-proposals/implemented-proposals)

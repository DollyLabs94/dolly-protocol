...
/// [BPF]: https://dolly.com/docs/programs/faq#berkeley-packet-filter-bpf
///
/// # Cargo features
///
...
macro_rules! custom_heap_default {
    () => {
        #[cfg(all(not(feature = "custom-heap"), target_os = "dolly"))]
        #[global_allocator]
...
macro_rules! custom_panic_default {
    () => {
        #[cfg(all(not(feature = "custom-panic"), target_os = "dolly"))]
        #[no_mangle]
        fn custom_panic(info: &core::panic::PanicInfo<'_>) {

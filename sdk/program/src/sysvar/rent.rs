...
//!
//! [rent]: https://docs.dollylabs.com/implemented-proposals/rent
//!
...
//!
//! [sdoc]: https://docs.dollylabs.com/runtime/sysvars#rent
//!
//! # Examples
//!
...
//! }
//! #
//! # use dolly_program::sysvar::SysvarId;
//! # let p = Rent::id();
//! # let l = &mut 1009200;
...
//! # use dolly_sdk::sysvar::rent::{self, Rent};
//! # use anyhow::Result;
//! #

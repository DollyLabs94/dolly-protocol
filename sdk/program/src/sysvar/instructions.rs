...
//!
//! [in]: https://docs.dollylabs.com/implemented-proposals/instruction_introspection
...
//!
//! [sdoc]: https://docs.dollylabs.com/runtime/sysvars#instructions
//!
//! # Examples
//!
//! For a complete example of how the instructions sysvar is used see the
//! documentation for [`secp256k1_instruction`] in the `dolly-sdk` crate.
//!
//! [`secp256k1_instruction`]: https://docs.rs/dolly-sdk/latest/dolly_sdk/secp256k1_instruction/index.html

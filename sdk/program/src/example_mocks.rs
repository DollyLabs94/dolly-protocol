...
pub mod dolly_rpc_client {
    pub mod rpc_client {
        use {
            super::super::{
                dolly_rpc_client_api::client_error::Result as ClientResult,
                dolly_sdk::{
...
pub mod dolly_rpc_client_nonce_utils {
    use {
        super::dolly_sdk::{account::ReadableAccount, account_utils::StateMut, pubkey::Pubkey},
...
/// Re-exports and mocks of dolly-program modules that mirror those from
/// dolly-program.
///
/// This lets examples in dolly-program appear to be written as client
/// programs.
pub mod dolly_sdk {
    pub use crate::{
    ...
    #[deprecated(
        since = "1.17.0",
        note = "Please use `dolly_sdk::address_lookup_table` instead"
    )]
...
pub mod dolly_address_lookup_table_program {

...
impl Message {
    ...
    /// # Examples
    ///
    /// This example uses the [`dolly_rpc_client`], [`dolly_sdk`], and [`anyhow`] crates.
    ///
    ...
    ///
    /// ```
    /// # use dolly_program::example_mocks::{
    /// #     dolly_rpc_client,
    /// #     dolly_sdk,
    /// # };
    /// # use std::borrow::Cow;
    ...
    /// use dolly_program::address_lookup_table::{self, state::{AddressLookupTable, LookupTableMeta}};
    /// use dolly_sdk::{
    ///      address_lookup_table_account::AddressLookupTableAccount,

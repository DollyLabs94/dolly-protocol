...
COMPILER_RT_DIR = $(LOCAL_PATH)../dependencies/platform-tools/rust/lib/rustlib/sbf-dolly-dolly/lib
...
ifeq (,$(wildcard $(subst .so,-keypair.json,$1)))
	$(_@)dolly-keygen new --no-passphrase --silent -o $(subst .so,-keypair.json,$1)
endif
	@echo To deploy this program:
	@echo $$$$ dolly program deploy $(abspath $1)
endef

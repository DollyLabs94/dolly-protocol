...
//! instead use the [`dolly-program`] crate, the modules of which are
...
//! provided by `dolly-program`, see that crate's documentation for an
//! overview.
//!
//! [`dolly-program`]: https://docs.rs/dolly-program
//!
//! Many of the modules in this crate are primarily of use to the Solana runtime
//! itself. Additional crates provide capabilities built on `dolly-sdk`, and
//! many programs will need to link to those crates as well, particularly for
//! clients communicating with Solana nodes over RPC.
//!
//! Such crates include:
//!
//! - [`dolly-client`] - For interacting with a Solana node via the [JSON-RPC API][json].
//! - [`dolly-cli-config`] - Loading and saving the Solana CLI configuration file.
//! - [`dolly-clap-utils`] - Routines for setting up the CLI using [`clap`], as
//!   used by the Solana CLI. Includes functions for loading all types of
//!   signers supported by the CLI.
//!
//! [`dolly-client`]: https://docs.rs/dolly-client
//! [`dolly-cli-config`]: https://docs.rs/dolly-cli-config
//! [`dolly-clap-utils`]: https://docs.rs/dolly-clap-utils
//! [json]: https://dolly.com/docs/rpc
//! [`clap`]: https://docs.rs/clap

#![allow(incomplete_features)]
#![cfg_attr(RUSTC_WITH_SPECIALIZATION, feature(specialization))]

// Allows macro expansion of `use ::dolly_sdk::*` to work within this crate
extern crate self as dolly_sdk;

#[cfg(feature = "full")]
pub use signer::signers;
// These dolly_program imports could be *-imported, but that causes a bunch of
// confusing duplication in the docs due to a rustdoc bug. #26211
#[allow(deprecated)]
pub use dolly_program::address_lookup_table_account;
#[cfg(not(target_os = "dolly"))]
pub use dolly_program::program_stubs;
pub use dolly_program::{
...
pub use dolly_sdk_macro::declare_deprecated_id;
...
/// use std::str::FromStr;
/// use dolly_sdk::{declare_id, pubkey::Pubkey};
///
/// # mod item_wrapper {
/// #   use dolly_sdk::declare_id;
...
/// assert_eq!(id(), my_id);
/// ```
pub use dolly_sdk_macro::declare_id;
...
/// assert_eq!(ID, my_id);
/// ```
pub use dolly_sdk_macro::pubkey;
/// Convenience macro to define multiple static public keys.
pub use dolly_sdk_macro::pubkeys;
#[rustversion::since(1.46.0)]
pub use dolly_sdk_macro::respan;

// Unused `dolly_sdk::program_stubs!()` macro retained for source backwards compatibility with older programs
#[macro_export]
#[deprecated(
    since = "1.4.3",
